...
class _KategoriLayananHukumState extends State<KategoriLayananHukum> {
  ...
  List<LayananHukumSubKategori> listArsipSub = [];
  Future getListLayananHukum() async {
    ...
    setState(() {
      ...
      if (list.data!.layananHukum!.to ==
          list.data!.layananHukum!.data!.length) {
        full = true;
        hasMore = false;
      } else {
        hasMore = true;
                            ...
                            itemBuilder: (context, index) {
                              if (index < listArsip.length) {
                                return GestureDetector(
                                  onTap: () async {
                                    setState(() {
                                      if (listArsip[index].idLayananHukum ==
                                          1) {
                                        id = "Notaris";
                                      } else {
                                        id = "Konsultan Hukum";
                                    ...
                                    context
                                        .read<LayananHukumCubit>()
                                        .getlayananHukumSub(
                                            listArsip[index].idLayananHukum!)
                                        .then((value) {
                                      if ((context
                                                  .bloc<LayananHukumCubit>()
                                                  .state as LayananHukumSukses)
