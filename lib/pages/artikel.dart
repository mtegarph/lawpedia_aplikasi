                          ...
                          return GestureDetector(
                            onTap: () {
                              context
                                  .read<ArtikelCubit>()
                                  .getDetailArtikel(
                                      listArtikelPopular[index].articleId!)
                                  .then((value) {
                                String? desc;
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: NetworkImage(listArtikel[i]
                                                      .articleThumbnail ==
                                                  null
                                              ? "https://i.pinimg.com/564x/94/17/82/941782f60e16a9d7f9b4cea4ae7025e0.jpg"
                                              : listArtikel[i]
