...
class DetailArtikel extends StatefulWidget {
  final int? id;
  final String? body;
  const DetailArtikel({Key? key, @required this.id, @required this.body})
      : super(key: key);
...
class _DetailArtikelState extends State<DetailArtikel> {
  ...
  Future refresh() async {
    ...
    context.read<ArtikelCubit>().getDetailArtikel(widget.id!).then((value) {
                            ...
                            child: SizedBox(
                                ...
                                child: WebView(
                                  ...
                                  onWebViewCreated: (WebViewController
                                    ...
                                    await (state is DetailArtikelSukses);
                                    setState(() {
                                      _web = widget.body;
                                    });
                                    print("Data: $_web");
