...
class DataListArticle {
    ...
    factory DataListArticle.fromJson(Map<String, dynamic> json) => DataListArticle(
        popularArticles: List<PopularArticle>.from(json["popular_articles"].map((x) => PopularArticle.fromJson(x))),
...
class Articles {
    ...
    factory Articles.fromJson(Map<String, dynamic> json) => Articles(
        ...
        data: List<PopularArticle>.from(json["data"].map((x) => PopularArticle.fromJson(x))),
...
class DataDetailArtikel {
    ...
    factory DataDetailArtikel.fromJson(Map<String, dynamic> json) => DataDetailArtikel(
